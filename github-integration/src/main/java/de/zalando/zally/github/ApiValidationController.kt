...
constructor(private val githubService: GithubService) {
    ...
    fun validatePullRequest(@RequestBody payload: String, @RequestHeader(value = "X-GitHub-Event") eventType: String) {
        ...
        val pullRequest = githubService.parsePayload(payload)
