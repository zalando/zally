...
class ApiViolationsControllerTest {
    ...
    fun violationsResponseReferencesFullGuidelinesUrl() {
        mvc.perform(
            ...
            .andExpect(content().string(containsString("https://github.com/schweizerischebundesbahnen/zally/blob/master/server/rules.md")))
            .andExpect(jsonPath("$.violations[*].rule_link", hasItem("https://github.com/schweizerischebundesbahnen/zally/blob/master/server/rules.md")))
